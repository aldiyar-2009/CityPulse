...
function Home() {
  ...
  if (loading) {
    return <LoadingSpinner text="Загружаем события..." />
  }
    ...
    <div className={styles.home}>
        ...
        <section className={styles.hero} aria-label="Главный баннер">
          ...
          >
            ...
            {featuredEvents.length > 1 && (
              <>
                <button className={styles.prevBtn} onClick={handlePrevSlide} aria-label="Предыдущий слайд">‹</button>
                <button className={styles.nextBtn} onClick={handleNextSlide} aria-label="Следующий слайд">›</button>
      ...
      <div className={styles.container}>
        ...
        {events.length === 0 && !loading && (
          <p className={styles.emptyMsg}>События не найдены.</p>
        )}
      </div>
    </div>
  )
